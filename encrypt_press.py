#!/usr/bin/env python3
"""Encrypt the press-map data for publishing.

Reads  private/press.json    (plaintext, gitignored)
Writes press/data.enc        (AES-256-GCM ciphertext)
...
SRC  = ROOT / "private" / "press.json"
OUT  = ROOT / "press" / "data.enc"
ITERS = 600_000
